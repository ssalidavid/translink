			...
			<div class="col-lg-12" >
				<section class="panel">
					<header class="panel-heading bg-info">
						<h1 class="text-infos py-4 pl-3tea py-2">MEMBER INFORMATION
						</h1> 
					</header>
	...
	<div id="modal_form" class="modal fade" role="dialog">
								...
								<div class="row">
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<input name="member_id" placeholder="member id" class="form-control" type="number" required min="0" minlength="4">
												<span class="help-block text-danger"></span>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-12">
													<select class="form-control" name="designation">
														<option value="<?=$roleRow->role; ?>"><?=$roleRow->name; ?></option>
													</select>
													<span class="help-block text-danger"></span>
												</div>
											</div>
		...
		<div id="view_modal_form" class="modal fade" role="dialog">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label col-md-12">Member Name</label>
												<div class="col-md-12">
													<input name="v_member_name" placeholder="Member name" class="form-control" type="text" readonly>
													<span class="help-block text-danger"></span>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-12">Member ID</label>
												<div class="col-md-12">
													<input name="v_member_id" placeholder="member id" class="form-control" type="text" readonly>
													<span class="help-block text-danger"></span>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-12">Next of Kin Name</label>
												<div class="col-md-12">
													<input type="text" name="v_nok_name" class="form-control" placeholder="next of kin name" readonly>
													<span class="help-block text-danger"></span>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-12">Gender</label>
												<div class="col-md-12">
													<select class="form-control" name="v_sex" readonly>
														<option value="">select your Gender</option>
														<option value="Male">Male</option>
														<option value="Female">Female</option>
													</select>
											...
											<div class="form-group">
												<label class="control-label col-md-12">Next of kin Contact</label>
												<div class="col-md-12">
													<input type="text" name="v_nok_contact" class="form-control" placeholder="next of kin contact" readonly>
													<span class="help-block text-danger"></span>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label col-md-12">Phone Number</label>
												<div class="col-md-12">
													<input type="text" name="v_contact" class="form-control" placeholder="phone number" value="+256 " readonly>
													<span class="help-block text-danger"></span>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-12">Date of Birth</label>
												<div class="col-md-12">
													<input name="v_birthday" placeholder="member birthday" class="form-control" type="date" readonly>
													<span class="help-block text-danger"></span>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-12">Nationality</label>
												<div class="col-md-12">
													<input type="text" name="v_nationality" class="form-control" placeholder="Staff Nationality" readonly>
													<span class="help-block text-danger"></span>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-12">Username</label>
												<div class="col-md-12">
													<input type="text" name="v_username" class="form-control" readonly>
													<span class="help-block text-danger"></span>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-12">Address</label>
												<div class="col-md-12">
													<input type="text" name="v_address" class="form-control" placeholder="member address" readonly>
													<span class="help-block text-danger"></span>
												</div>
											</div>		                					</div>
											<div class="col-md-4">
		    ...
		    $(document).ready(function (){
		    	$('#memberNav').css('background-color','#61a434');
		    	$('#table').DataTable({
		    		"processing": true,
		    		"serverSide": true, 
		    		"order": [], 
		            ...
		            "ajax": {
		            	"url": "<?php echo base_url('admin/member/generate_member');?>",
		            	"type": "POST"
		            },
		    ...
		    function save_member(){
		        ...
		        var url;
		        if (save_method == 'add') {
		        	url = "<?php echo base_url('admin/member/add_new_member');?>";
		        } else {
		        	url = "<?php echo base_url('admin/member/update_member_records');?>";
		        }
			...
			function update_member(id) {
		        ...
		        $.ajax({
		        	url: "<?php echo base_url('admin/member/get_records_by_member_id');?>/" + id,
		        	type: "GET",
		        	dataType: "JSON",
		        	success: function (data){
		        		$('[name="mem_id"]').val(data.id);
		    ...
		    function view_member(member_id) {
		    	//Ajax Load data from ajax
		    	$.ajax({
		    		url: "<?php echo base_url('admin/member/get_records_by_member_id') ?>/" + member_id,
		    		type: "GET",
		    		dataType: "JSON",
		    		success: function (data){
		    			$('[name="v_member_id"]').val(data.member_id);
		    			$('[name="v_member_name"]').val(data.name);
		    			$('[name="v_birthday"]').val(data.birthday);
		    			$('[name="v_sex"]').val(data.sex);
		    			$('[name="v_address"]').val(data.address);
		    			$('[name="v_contact"]').val(data.phone);
		    			$('[name="v_nok_name"]').val(data.nok_name);
		    			$('[name="v_nationality"]').val(data.nationality);
		    			// $('[name="v_roleid"]').val(data.roleid);
		    			$('[name="v_nok_contact"]').val(data.nok_contact);
		    			$('[name="v_username"]').val(data.username);
		    			$('#view_modal_form').modal('show'); 
		    			$('[name="v_designation"]').val(data.designation);
		    			$('[name="v_join_date"]').val(data.join_date);
		    ...
		    function delete_member(memberid,member_name){
		    	...
		    	function(){
		    		$.ajax({
		    			url: "<?php echo base_url('admin/member/delete_member_record') ?>/" + memberid,
		    			type: "POST",
		    			dataType: "JSON",
		    			success: function (data)
		    			{
		    		...
		    		function (isConfirm) {
		    			if (isConfirm) {
		    				$.ajax({
		    					...
		    					url: "<?php echo site_url('admin/member/bulk_member_delete');?>",
		    					dataType: "JSON",
		    					success: function (data){
		    						if (data.status)
		    						{
